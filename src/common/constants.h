...
const std::string NATS_URL_CLIENT="nats://ivan:secret@localhost:4222/";
const std::string NATS_URL_SERVER="nats://ivan:secret@localhost:4223/";
const std::string MEMCACHED_URL_CLIENT="--SERVER=localhost:11211";
const std::string MEMCACHED_URL_SERVER="--SERVER=localhost:11212";
