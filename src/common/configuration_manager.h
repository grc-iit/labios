...
public:
    std::string NATS_URL_CLIENT = "nats://localhost:4222/";
    std::string NATS_URL_SERVER = "nats://localhost:4223/";
    std::string MEMCACHED_URL_CLIENT = "--SERVER=localhost:11211";
    std::string MEMCACHED_URL_SERVER = "--SERVER=localhost:11212";
