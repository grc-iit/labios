...
******************************************************************************/
std::vector<Statistics::calculations> Statistics::readBinary(const std::string &path) {
...
unsigned long Statistics::consolidatedSum(std::vector<Statistics::calculations> &data) {
    if (data.empty()) {
        return 0;
    }
...
double Statistics::consolidatedMedian(std::vector<Statistics::calculations> &data) {
    if (data.empty()) {
        return 0;
    }
    ...
    for (auto &chunk : data) {
        weighted_median += chunk.median * (chunk.length / static_cast<double>(data_length));
    }

    return weighted_median;
}

double Statistics::consolidatedMean(std::vector<Statistics::calculations> &data) {
    if (data.empty()) {
        return 0;
    }
...
unsigned long Statistics::totalSize(std::vector<Statistics::calculations> &data) {
